...
-- 添加所有城市（city字典）
-- 使用 INSERT ... ON CONFLICT 避免重复
INSERT INTO sys_dict_item (dict_code, item_label, item_value, sort_order, status, label_i18n, parent_value)
VALUES
  -- ========== 直辖市（4个）==========
  -- 北京（已有：北京）
  ('city', '北京', '110100', 0, true, '{"en-US": "Beijing", "zh-CN": "北京"}'::jsonb, 'BJ'),
  
  -- 上海（已有：上海）
  ('city', '上海', '310100', 0, true, '{"en-US": "Shanghai", "zh-CN": "上海"}'::jsonb, 'SH'),
  
  -- 天津
  ('city', '天津', '120100', 0, true, '{"en-US": "Tianjin", "zh-CN": "天津"}'::jsonb, 'TJ'),
  
  -- 重庆（已有：重庆）
  ('city', '重庆', '500100', 0, true, '{"en-US": "Chongqing", "zh-CN": "重庆"}'::jsonb, 'CQ'),
  ...
  ('city', '廊坊', '131000', 9, true, '{"en-US": "Langfang", "zh-CN": "廊坊"}'::jsonb, 'HE'),
  ...
  -- ========== 吉林省 ==========
  ('city', '长春', '220100', 0, true, '{"en-US": "Changchun", "zh-CN": "长春"}'::jsonb, 'JL'),
  ...
  -- ========== 江苏省 ==========
  ('city', '南京', '320100', 0, true, '{"en-US": "Nanjing", "zh-CN": "南京"}'::jsonb, 'JS'),
  ...
  ('city', '苏州', '320500', 4, true, '{"en-US": "Suzhou", "zh-CN": "苏州"}'::jsonb, 'JS'),
  ('city', '南通', '320600', 5, true, '{"en-US": "Nantong", "zh-CN": "南通"}'::jsonb, 'JS'),
  ...
  -- ========== 浙江省 ==========
  ('city', '杭州', '330100', 0, true, '{"en-US": "Hangzhou", "zh-CN": "杭州"}'::jsonb, 'ZJ'),
  ('city', '宁波', '330200', 1, true, '{"en-US": "Ningbo", "zh-CN": "宁波"}'::jsonb, 'ZJ'),
  ('city', '温州', '330300', 2, true, '{"en-US": "Wenzhou", "zh-CN": "温州"}'::jsonb, 'ZJ'),
  ('city', '嘉兴', '330400', 3, true, '{"en-US": "Jiaxing", "zh-CN": "嘉兴"}'::jsonb, 'ZJ'),
  ('city', '湖州', '330500', 4, true, '{"en-US": "Huzhou", "zh-CN": "湖州"}'::jsonb, 'ZJ'),
  ('city', '绍兴', '330600', 5, true, '{"en-US": "Shaoxing", "zh-CN": "绍兴"}'::jsonb, 'ZJ'),
  ('city', '金华', '330700', 6, true, '{"en-US": "Jinhua", "zh-CN": "金华"}'::jsonb, 'ZJ'),
  ...
  -- ========== 安徽省 ==========
  ('city', '合肥', '340100', 0, true, '{"en-US": "Hefei", "zh-CN": "合肥"}'::jsonb, 'AH'),
  ...
  -- ========== 福建省 ==========
  ('city', '福州', '350100', 0, true, '{"en-US": "Fuzhou", "zh-CN": "福州"}'::jsonb, 'FJ'),
  ('city', '厦门', '350200', 1, true, '{"en-US": "Xiamen", "zh-CN": "厦门"}'::jsonb, 'FJ'),
  ('city', '莆田', '350300', 2, true, '{"en-US": "Putian", "zh-CN": "莆田"}'::jsonb, 'FJ'),
  ('city', '三明', '350400', 3, true, '{"en-US": "Sanming", "zh-CN": "三明"}'::jsonb, 'FJ'),
  ('city', '泉州', '350500', 4, true, '{"en-US": "Quanzhou", "zh-CN": "泉州"}'::jsonb, 'FJ'),
  ...
  -- ========== 山东省 ==========
  ('city', '济南', '370100', 0, true, '{"en-US": "Jinan", "zh-CN": "济南"}'::jsonb, 'SD'),
  ('city', '青岛', '370200', 1, true, '{"en-US": "Qingdao", "zh-CN": "青岛"}'::jsonb, 'SD'),
  ('city', '淄博', '370300', 2, true, '{"en-US": "Zibo", "zh-CN": "淄博"}'::jsonb, 'SD'),
  ('city', '枣庄', '370400', 3, true, '{"en-US": "Zaozhuang", "zh-CN": "枣庄"}'::jsonb, 'SD'),
  ('city', '东营', '370500', 4, true, '{"en-US": "Dongying", "zh-CN": "东营"}'::jsonb, 'SD'),
  ('city', '烟台', '370600', 5, true, '{"en-US": "Yantai", "zh-CN": "烟台"}'::jsonb, 'SD'),
  ('city', '潍坊', '370700', 6, true, '{"en-US": "Weifang", "zh-CN": "潍坊"}'::jsonb, 'SD'),
  ('city', '济宁', '370800', 7, true, '{"en-US": "Jining", "zh-CN": "济宁"}'::jsonb, 'SD'),
  ('city', '泰安', '370900', 8, true, '{"en-US": "Tai'an", "zh-CN": "泰安"}'::jsonb, 'SD'),
  ('city', '威海', '371000', 9, true, '{"en-US": "Weihai", "zh-CN": "威海"}'::jsonb, 'SD'),
  ('city', '日照', '371100', 10, true, '{"en-US": "Rizhao", "zh-CN": "日照"}'::jsonb, 'SD'),
  ('city', '临沂', '371300', 11, true, '{"en-US": "Linyi", "zh-CN": "临沂"}'::jsonb, 'SD'),
  ...
  -- ========== 河南省 ==========
  ('city', '郑州', '410100', 0, true, '{"en-US": "Zhengzhou", "zh-CN": "郑州"}'::jsonb, 'HA'),
  ('city', '开封', '410200', 1, true, '{"en-US": "Kaifeng", "zh-CN": "开封"}'::jsonb, 'HA'),
  ('city', '洛阳', '410300', 2, true, '{"en-US": "Luoyang", "zh-CN": "洛阳"}'::jsonb, 'HA'),
  ('city', '平顶山', '410400', 3, true, '{"en-US": "Pingdingshan", "zh-CN": "平顶山"}'::jsonb, 'HA'),
  ('city', '安阳', '410500', 4, true, '{"en-US": "Anyang", "zh-CN": "安阳"}'::jsonb, 'HA'),
  ...
  -- ========== 湖北省 ==========
  ('city', '武汉', '420100', 0, true, '{"en-US": "Wuhan", "zh-CN": "武汉"}'::jsonb, 'HB'),
  ...
  -- ========== 广东省 ==========
  ('city', '广州', '440100', 0, true, '{"en-US": "Guangzhou", "zh-CN": "广州"}'::jsonb, 'GD'),
  ('city', '韶关', '440200', 1, true, '{"en-US": "Shaoguan", "zh-CN": "韶关"}'::jsonb, 'GD'),
  ('city', '深圳', '440300', 2, true, '{"en-US": "Shenzhen", "zh-CN": "深圳"}'::jsonb, 'GD'),
  ('city', '珠海', '440400', 3, true, '{"en-US": "Zhuhai", "zh-CN": "珠海"}'::jsonb, 'GD'),
  ('city', '汕头', '440500', 4, true, '{"en-US": "Shantou", "zh-CN": "汕头"}'::jsonb, 'GD'),
  ('city', '佛山', '440600', 5, true, '{"en-US": "Foshan", "zh-CN": "佛山"}'::jsonb, 'GD'),
  ('city', '江门', '440700', 6, true, '{"en-US": "Jiangmen", "zh-CN": "江门"}'::jsonb, 'GD'),
  ...
  ('city', '惠州', '441300', 10, true, '{"en-US": "Huizhou", "zh-CN": "惠州"}'::jsonb, 'GD'),
  ...
  ('city', '清远', '441800', 15, true, '{"en-US": "Qingyuan", "zh-CN": "清远"}'::jsonb, 'GD'),
  ('city', '东莞', '441900', 16, true, '{"en-US": "Dongguan", "zh-CN": "东莞"}'::jsonb, 'GD'),
  ('city', '中山', '442000', 17, true, '{"en-US": "Zhongshan", "zh-CN": "中山"}'::jsonb, 'GD'),
  ...
  -- ========== 四川省 ==========
  ('city', '成都', '510100', 0, true, '{"en-US": "Chengdu", "zh-CN": "成都"}'::jsonb, 'SC'),
  ...
  ('city', '遵义', '520300', 2, true, '{"en-US": "Zunyi", "zh-CN": "遵义"}'::jsonb, 'GZ'),
  ...
  -- ========== 云南省 ==========
  ('city', '昆明', '530100', 0, true, '{"en-US": "Kunming", "zh-CN": "昆明"}'::jsonb, 'YN'),
  ...
  -- ========== 陕西省 ==========
  ('city', '西安', '610100', 0, true, '{"en-US": "Xi'an", "zh-CN": "西安"}'::jsonb, 'SN'),
  ...
  -- ========== 甘肃省 ==========
  ('city', '兰州', '620100', 0, true, '{"en-US": "Lanzhou", "zh-CN": "兰州"}'::jsonb, 'GS'),
  ...
  -- ========== 广西壮族自治区 ==========
  ('city', '南宁', '450100', 0, true, '{"en-US": "Nanning", "zh-CN": "南宁"}'::jsonb, 'GX'),
  ('city', '柳州', '450200', 1, true, '{"en-US": "Liuzhou", "zh-CN": "柳州"}'::jsonb, 'GX'),
  ('city', '桂林', '450300', 2, true, '{"en-US": "Guilin", "zh-CN": "桂林"}'::jsonb, 'GX'),
  ...
  ('city', '百色', '451000', 9, true, '{"en-US": "Baise", "zh-CN": "百色"}'::jsonb, 'GX'),
  ...
  -- ========== 新疆维吾尔自治区 ==========
  ('city', '乌鲁木齐', '650100', 0, true, '{"en-US": "Urumqi", "zh-CN": "乌鲁木齐"}'::jsonb, 'XJ'),
